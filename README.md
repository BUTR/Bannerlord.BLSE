...
* **Special K Support** - No action is required without ReShade. When ReShade is installed, rename it to ReShade64.dll and Special K should be loaded as SpecialK64.dll ([use local installation﻿](https://wiki.special-k.info/SpecialK/Local) without the renaming). Use SKIF to launch BLSE.
